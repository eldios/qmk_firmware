/* Copyright 2021 eldios GMMK Pro ANSI Enhanced Keymap File
...
//      ESC      F1       F2       F3       F4       F5        F6       F7       F8       F9       F10      F11      F12      Delete        Rotary(Mute)
//      `        1        2        3        4        5         6        7        8        9        0         -       (=)      BackSpc           Delete
//      Tab      Q        W        E        R        T         Y        U        I        O        P        [        ]        \                 PgUp
//      Caps     A        S        D        F        G         H        J        K        L        ;        '                 Enter             PgDn
//      Sh_L              Z        X        C        V         B        N        M        ,        .        /                 Sh_R     Up       End
//      Ct_L     Win_L    Alt_L                                SPACE                               Alt_R    MO(3)    Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    KC_1,          _______,
    ...
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   TO(0),          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    KC_2,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),
    ...
    [3] = LAYOUT(
        _______,   TO(1),   TO(2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
      LED_TILDE,   LED_1,   LED_2,   LED_3,   LED_4,   LED_5,   LED_6,   LED_7,   LED_8,   LED_9,   LED_0,LED_MINS, LED_EQL,   TO(0),          _______,
        QMKBEST, _______, _______, _______, RGB_TOG, RGB_MOD, _______, _______, _______, _______, NK_TOGG,   DEBUG,   RESET,    KC_3,          _______,
        KC_CAPS,  AGRAVE, _______, _______, RGB_VAI, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______, _______, _______, _______, RGB_VAD,   SHRUG,   STRUT,    POOP,   TFLIP,  DPOINT,  SARCSM,                   _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case QMKBEST: // little demo of sending strings with one keypress
    ...
    case AGRAVE: // little demo of sending strings with one keypress
      if (record->event.pressed) { // when keycode QMKBEST is pressed
          // è - caffè – kaf-feh
          // é – perché – per-keh
