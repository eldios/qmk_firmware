...
/* FN
 * ,-----------------------------------------------------------------------------------.
 * |RGBTgl|SHRUG |STRUT |      |      |      |      |      |      |      |      | POOP |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | RGB+ |TFLIP |DPOINT|      |      |      |      |      |      |      |PrtScr|UC_MOD|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |UC_Wnc|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |UC_Lin|
...
[_FN] = LAYOUT_preonic_grid(
  RGB_TOG,  SHRUG,    STRUT,    _______, _______, _______, _______, _______, _______, _______, _______, POOP,
  RGB_MOD,  TFLIP,    DPOINT,   _______, _______, _______, _______, _______, _______, _______, KC_PSCR, UC_MOD,
  RGB_RMOD, _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, UC_M_WC,
  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, UC_M_LN,
  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, TG_NUMP, _______, UC_M_MA
),
...
[_NUMPAD] = LAYOUT_preonic_grid(
  ...
  KC_TAB,   _______,  _______,  _______,  _______,  _______,  _______,   KC_P4,   KC_P5,    KC_P6,    KC_PAST,  KC_DEL,
  KC_ESC,   _______,  _______,  _______,  _______,  _______,  _______,   KC_P1,   KC_P2,    KC_P3,    KC_PMNS,  _______,
